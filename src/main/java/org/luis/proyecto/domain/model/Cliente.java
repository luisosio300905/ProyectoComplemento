...
public class Cliente {
    ...
    public Integer getTipDocIdenId() { return tipDocIdenId; }
    public void setTipDocIdenId(Integer tipDocIdenId) { this.tipDocIdenId = tipDocIdenId; }
