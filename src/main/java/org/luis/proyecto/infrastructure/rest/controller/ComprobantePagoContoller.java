...
public class ComprobantePagoContoller {
    ...
    public ResponseEntity<List<ComprobantePagoResponse>> getComprobantePagos() {
        return ResponseEntity
                ...
                .body(comprobantePagoService.obtenerTodos().stream()
    ...
    public ResponseEntity<ComprobantePagoResponse> createComprobantePago(@RequestBody ComprobantePagoRequest ComprobantePagoRequest) {
        return ResponseEntity
                ...
                .body(comprobantePagoMapper.toResponse(
                        comprobantePagoService.crear(comprobantePagoMapper.toDomain(ComprobantePagoRequest))));
    }

    @GetMapping("/{id}")
    public ResponseEntity<ComprobantePagoResponse> getComprobantePago(@PathVariable String id) {
        return ResponseEntity
                .status(HttpStatus.OK)
                .body(comprobantePagoMapper.toResponse(comprobantePagoService.obtenerComprobantePago(id)));
    }

    @PutMapping("/{id}")
    public ResponseEntity<ComprobantePagoResponse> updateComprobantePago(@PathVariable String id, @RequestBody ComprobantePagoRequest ComprobantePagoRequest) {
        return ResponseEntity
                .status(HttpStatus.OK)
                .body(comprobantePagoMapper.toResponse(
                        comprobantePagoService.actualizar(id, comprobantePagoMapper.toDomain(ComprobantePagoRequest))));
    }
